...
describe('Petpooja Push Menu Items (Menu items) Test Cases', () => {
  ...
  test('Deleting existing menu items', async () => {
    ...
    expect(read_menu_item_item_addon_group.length).toBe(0);
  ...
  test('Adding new item in that existing sub category', async () => {
    ...
    expect(read_menu_items.length).toBe(6);
