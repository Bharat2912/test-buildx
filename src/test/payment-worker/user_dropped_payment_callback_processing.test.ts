...
describe('Testing user dropped payment callback worker processing', () => {
  const customer_id = '33c6fdbc-8df6-4541-9d3f-f9e5ba4c0242';
  test('User Dropped payment details should be processed and should not place order at vendor', async () => {
    /* =================================
                *CREATE CART
    ==================================== */
    ...
    await processOrderPaymentDetails({
      data: {
        ...
        payment_details: {
          ...
          transaction_time: new Date('2022-05-25T08:55:34.000Z'),
        },
      },
      event_time: '2022-05-25T14:35:38+05:30',
      type: ExternalPaymentEvent.PAYMENT_USER_DROPPED_WEBHOOK,
    });
      ...
      payment_attempt_details: [
        {
          ...
          bank_reference: '1803592531',
          external_payment_id: '9756722609',
          external_payment_status: 'USER_DROPPED',
          payment_group: 'net_banking',
          payment_message:
            'User dropped and did not complete the two factor authentication',
          payment_method: {
          ...
          transaction_amount: 134.42,
          transaction_time: '2022-05-25T08:55:34.000Z',
        },
      ],
    });
    expect(
